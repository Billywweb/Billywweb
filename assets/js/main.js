...
jQuery(function ($) {
	...
	$(window).scroll(function () {
		...
		var widget = $('.billy-body .side-widget');
...
jQuery(function ($) {
	...
	// Slider
	$('.billy-section .slider').each(function () {
	...
	// Thumbnail Slider
	const ThumbnailSliderControl = new Swiper('.billy-section .thumbnail-slider .thumbnail-slider-control', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		breakpoints: {
	...
	const ThumbnailSlider = new Swiper('.billy-section .thumbnail-slider .thumbnail-slider-items', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
jQuery(function ($) {
	...
	var section = $('.billy-section .shuffle');
...
jQuery(function ($) {
	$('.billy-section .gallery').lightGallery({
		selector: '.billy-section .gallery .lightbox-link:not(.prevent)',
		thumbnail: false,
		share: false,
		download: false
	})
